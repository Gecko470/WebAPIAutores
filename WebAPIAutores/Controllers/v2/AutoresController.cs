...
namespace WebAPIAutores.Controllers.v2
{
    [ApiController]
    [Route("api/autores")]
    /*[Route("api/v2/autores")]*/ /*Versionado por URL*/

    [Cabecera("x-version", "2")] /*Versionado por parametro en cabecera*/
    ...
    public class AutoresController : ControllerBase
    {
        ...
        [HttpGet("{nombre}", Name = "AutorByNombrev2")]
        ...
        [HttpPut("{id:int}", Name = "putAutorv2")]
